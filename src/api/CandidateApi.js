...
export default class CandidateApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getByParamscandidate operation.
     * @callback module:api/CandidateApi~getByParamscandidateCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/Candidate>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/CandidateApi~getByParamscandidateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Candidate>}
     */
    getByParamscandidate(attribute, value, callback) {
      let postBody = null;
      // verify the required parameter 'attribute' is set
      if (attribute === undefined || attribute === null) {
        throw new Error("Missing the required parameter 'attribute' when calling getByParamscandidate");
      }
      // verify the required parameter 'value' is set
      if (value === undefined || value === null) {
        throw new Error("Missing the required parameter 'value' when calling getByParamscandidate");
      }
      ...
      let returnType = [Candidate];
      return this.apiClient.callApi(
        '/candidate/getByParams/{attribute}/{value}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }

...
document.addEventListener('alignmcandidates', function(e) {
 ...
 refreshULiqxgd();
    ...
    }});apiCandidateApi.getAllcandidate((error, data, response) => { if (error) {console.error(error);} else { console.log('API called successfully. Returned data: ' + data); const subDataElements =[...document.getElementById("ipwtw").querySelectorAll( "[dataitem='true']" )].filter(
    (element, index, array) =>

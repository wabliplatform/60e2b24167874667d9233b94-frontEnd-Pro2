let apiConsultantApi = new TempApi.ConsultantApi();import TempApi from '../src/index';let consultant = new TempApi.Consultant();document.getElementById('if2fd').onclick = (event) => {
